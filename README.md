# 5chutil
５ちゃんねる の スレッドページにいくつかの機能を追加します。
...
- 画像リンクにマウスオーバーすると、より大きなサイズでポップアップします。
